(function() {
  ...
  GameView.prototype.bindKeyHandlers = function() {
    // var that = this;
    // key('left', function(){ that.game.currentPiece.playerMove("left", that.ctx);});
    // key('down', function(){ that.game.currentPiece.playerMove("down", that.ctx);});
    // key('right', function(){ that.game.currentPiece.playerMove("right", that.ctx);});
