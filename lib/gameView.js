(function() {
  ...
  GameView.prototype.start = function(){
    ...
    setInterval(this.game.draw.bind(this.game, this.ctx), 1000/60);
    setInterval(this.game.clearLines.bind(this.game, this.ctx), 1000/60);
    setInterval(this.game.deleteClearedPieces.bind(this.game), 1000/60);
    setInterval(this.game.moveCurrentPiece.bind(this.game, this.ctx), 1000/3);
